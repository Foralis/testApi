...
public class Tests2 {
    ...
    @Test
    public void testGettingAllBreeds() throws ApiException {
//        String json = "{\n" +
//                "    \"message\": {\n" +
//                "        \"affenpinscher\": [],\n" +
//                "        \"african\": []\n" +
